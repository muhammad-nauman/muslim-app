...
<div class="row">
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ $categoriesCount }}</h1>
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <span class="label label-primary pull-right">Devices</span>
                <h5>Android</h5>
            </div>
            <div class="ibox-content">
                <h1 class="no-margins">{{ $devicesAndroid }}</h1>
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ $devicesIos }}</h1>
                <div class="stat-percent font-bold text-navy">44% <i class="fa fa-level-up"></i></div>
                <small>New visits</small>
            </div>
        </div>
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <span class="label label-primary pull-right">Content</span>
                <h5>Articles</h5>
            </div>
            <div class="ibox-content">
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ $audiosCount }}</h1>
                <div class="stat-percent font-bold text-navy">44% <i class="fa fa-level-up"></i></div>
                <small>New visits</small>
            </div>
        </div>
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ $monthlyNewUsersCount }}</h1>
                <div class="stat-percent font-bold text-navy"> <i class="fa fa-level-up"></i></div>
                <small>Since {{ now()->startOfMonth()->format('l jS \\of F Y') }}</small>
            </div>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ $todayActiveUsersCount }}</h1>
                <div class="stat-percent font-bold text-danger"><i class="fa fa-level-down"></i></div>
                <small>Since Today, {{ now()->startOfDay()->toTimeString() }}</small>
            </div>
        </div>
    </div>
</div>
...
<div class="footer">
    <div>
        <strong>Copyright</strong> Muslim App &copy; {{ now()->year }}
    </div>
</div>
</div>
